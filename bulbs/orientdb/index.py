...
#
"""
An interface for interacting with indices on OrientDB.
...
class VertexIndexProxy(IndexProxy):
    ...
    """
    Manage vertex indices on OrientDB.
    ...
    :type client: bulbs.orientdb.client.OrientDBClient
    ...
    def create(self, index_name):
        ...
        :rtype: bulbs.orientdb.index.Index
    ...
    def delete(self, index_name):
        ...
        :rtype: bulbs.orientdb.client.OrientDBResponse
...
class EdgeIndexProxy(IndexProxy):
    ...
    """
    Manage edge indices on OrientDB.
...
class Index(object):
    ...
    def count(self, key=None, value=None, **pair):
        """
        Return a count of all elements with 'key' equal to 'value'
            in the index.
...
class ManualIndex(Index):
    ...
    :param result: The result list returned by OrientDB.
    ...
    def put(self, _id, key=None, value=None, **pair):
        """
        Put an element into the index at key/value and return OrientDB's
        response.
    ...
    def update(self, _id, key=None, value=None, **pair):
        """
        Update the element ID for the key and value and return OrientDBs'
        response.
    ...
    def put_unique(self, _id, key=None, value=None, **pair):
        ...
        of 1 element returned for that key/value pair. Return OrientDB's
        response.
...
class AutomaticIndex(Index):
    ...
    def rebuild(self):
        ...
        # but OrientDB returns lower-case class names for index_class
