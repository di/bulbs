...
from bulbs.orientdb import Graph, OrientDBClient, VertexIndexProxy, \
    EdgeIndexProxy, ManualIndex
#from bulbs.tests import RestTestCase
from bulbs.tests import GremlinTestCase

# Setting a module var looks to be the easiest way to do this
db_name = "GratefulDeadConcerts"  # emptygraph has mock transactions enabled by default
